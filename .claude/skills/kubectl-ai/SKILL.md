...
## Ary's Evolved Todo Examples

```bash
# Deploy Ary's Evolved Todo components
kubectl-ai -quiet "create a deployment for evolved-todo-api with image evolved-todo/api:latest on port 8000"
kubectl-ai -quiet "create a ClusterIP service for the evolved-todo-api deployment"

# Configure networking
kubectl-ai -quiet "create an ingress for evolved-todo with /api pointing to api service and / pointing to web service"

# Troubleshoot
kubectl-ai -quiet "why is the evolved-todo-api pod not starting?"
kubectl-ai -quiet "check the logs from all evolved-todo pods"

# Scale for load
kubectl-ai -quiet "scale all evolved-todo deployments to 3 replicas"
```
