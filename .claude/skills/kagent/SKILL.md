...
- **Kubernetes-Native Agents**: Define AI agents as CRDs
- **Cluster Analysis**: AI-powered health checks and optimization
- **Extensibility**: Custom tools and integrations
...
## Use Cases for Ary's Evolved Todo
...
- **operating-k8s-local** - Local K8s operations
